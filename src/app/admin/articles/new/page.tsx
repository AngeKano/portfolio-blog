  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          data.error || "Erreur lors de la création de l'article"
        );
      }
      ...
      showError(err.message || "Impossible de créer l'article");
      console.error(err);
    } finally {
  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold mt-2">Nouvel Article</h1>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-primary-600 text-red-500 rounded-md hover:bg-primary-700 flex items-center"
              >
                {isSubmitting ? (
                  <>

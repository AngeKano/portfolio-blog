...
const ArticleSocialShare: React.FC<ArticleSocialShareProps> = ({ title, url, description }) => {
  ...
  return (
    <div className="flex flex-col justify-center py-6 border-t border-b border-gray-200">
      <h3 className="text-center font-medium text-gray-700 mb-4">Partager cet article</h3>
